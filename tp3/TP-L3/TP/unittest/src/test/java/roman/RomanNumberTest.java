...
public class RomanNumberTest {
  ...
  public void fromRomanKnownValues() {
	...
	public void fromRomanToDecimal() {
		RomanNumber.valueOf("XXXI");
	}

	// int -> RomanNumber
	@Test
	public void fromDecimalToRoman() {
		RomanNumber.valueOf(31);
	}
  ...
  public void toRomanZero() {
	...
	// float -> RomanNumber
	@Test(expected = IllegalArgumentException.class)
	public void toRomanEntiere() {
		RomanNumber.valueOf(4.5);
	}

	// int -> RomanNumber
	@Test(expected = IllegalArgumentException.class)
	public void toRomanOutOfBound() {
		RomanNumber.valueOf(4000);
	}

	// RomanNumber -> int
	@Test(expected = IllegalArgumentException.class)
	public void toRomanRepeatSymbol() {
		RomanNumber.valueOf("IIII");
	}

	// RomanNumber -> int
	@Test(expected = IllegalArgumentException.class)
	public void toRomanRepeatPairs() {
		RomanNumber.valueOf("VV");
	}

	// RomanNumber -> int
	@Test(expected = IllegalArgumentException.class)
	public void toRomanIncorrectPrevious() {
		RomanNumber.valueOf("XCX");
	}

	// int -> RomanNumber	
	@Test
	public void returnCapitals() {
		RomanNumber.toRoman(1754);
	}

	// RomanNumber -> int
	@Test(expected = IllegalArgumentException.class)
	public void onlyCapitals() {
		RomanNumber.fromRoman("Xx");
	}
